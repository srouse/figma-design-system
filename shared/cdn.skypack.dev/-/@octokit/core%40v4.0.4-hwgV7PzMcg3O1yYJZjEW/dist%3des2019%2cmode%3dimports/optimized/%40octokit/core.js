...
;
import {request as request2} from "/-/@octokit/request@v6.0.1-rQnUxH7bEDeCW9jn9uoR/dist=es2019,mode=imports/optimized/@octokit/request.js";
import {withCustomRequest} from "/-/@octokit/graphql@v5.0.0-og38x9UCxfOFqy1S5nAJ/dist=es2019,mode=imports/optimized/@octokit/graphql.js";
import {createTokenAuth} from "/-/@octokit/auth-token@v3.0.0-WuYAgrf6nieRcRqBKsDm/dist=es2019,mode=imports/optimized/@octokit/auth-token.js";
const VERSION = "4.0.4";
class Octokit {
  constructor(options = {}) {
